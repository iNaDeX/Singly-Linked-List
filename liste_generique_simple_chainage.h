...
// Supprime le maillon de queue de liste, sans détruire la donnée pointée
...
// Déréférence un élément précis de la liste, reçu en paramètre
...
-> par exemple, la fonction de recherche reçoit en + le nom du film à chercher
